...
public:
    ...
    // Lit une ligne sur le port série puis traite l'accès
    void processAccess();
    // Traite une ligne déjà lue (routage multi-scénarios sur un même port)
    void processAccess(const QString &message);
